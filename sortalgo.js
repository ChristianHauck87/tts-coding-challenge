...
let jsonData = require('./data/data.json');
	...
	// sort function for each age cohort
	...
	module.exports.studentsByAgeCohorts = [belowthirty, betweenthirtyoneandthirtyfive, betweenthirtysixandfourty, betweenfourtyoneandfourtyfive, betweenfourtysixandfifty, olderfifty];
